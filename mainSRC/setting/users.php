...
class users
{
    ...
    protected function saveUser()
    {
        ...
        else
        {
            ...
            if ($check_user_protected)
                $this->error[] = "Пользователь защещен от изменения";
        ...
        if ($check_login)
            $this->error[] = "Пользователь с логином " . $this->data['user_login'] . " сущетвует";
    ...
    public function addUser($data)
    {
        ...
        if ((int)$data['user_phone'] === null || (int)trim($data['user_phone']) === 0)
        {
