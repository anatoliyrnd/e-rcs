...
if ($rez['user_token']===$data['token']){
  ...
  if ($rez['user_level']=='2' AND $data['mobile']){
...
$_SESSION['hit'] = 0;
if ($user_level==3)
{// Перенаправляем диспетчера на основную страницу работы с активными заявками сотрудников для работы с их заявками
